    ...
    <div style="width: 100%">
        ...
        <el-dialog
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="warning" @click="refuse">拒 绝</el-button>
    ...
    export default {
        ...
        methods: {
            initAppatts(){
                ...
                this.getRequest('/attendance/transactionmanagement/readydoapp/?page=' + this.page + '&size=' + this.size).then(resp => {
            ...
            refuse(){
                this.appatt.isapprove=false;
                this.putRequest("/attendance/transactionmanagement/", this.appatt).then(resp => {
                    if (resp) {
